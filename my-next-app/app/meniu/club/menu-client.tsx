...
export function ClubMenuClient({ menu }: { menu: CategoryWithItems[] }) {
      ...
      {menu.length === 0 ? (
        ...
        <>
          ...
          <CategoryTabs
            ...
            activeClassName="bg-[#ff3da3] text-white"
            inactiveClassName="border border-white/15 text-[#f5f0e8]/50 hover:border-[#ff3da3]/40 hover:text-[#f5f0e8]"
          />
